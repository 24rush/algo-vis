Am invatat in lectiile trecute cum sa declaram variabile si functii noi iar in aceasta lectie vom discuta despre ciclul de viata sau domeniul unei variabile (engl. _scope_). 
