function SimpleTour() {
    let algovisContainer = document.querySelector("[class=algovis]");
    if (algovisContainer && algovisContainer.querySelector('[av-bind-onclick="onAutoplayToggled"] > i').classList.contains('bi-pause-fill'))
        algovisContainer.querySelector('[av-bind-onclick="onAutoplayToggled"]').click()
